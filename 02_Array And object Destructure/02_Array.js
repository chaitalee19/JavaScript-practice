...
console.log(Array.isArray("chaitalee"));//false
console.log(Array.from("chaitalee"));//[ 'c', 'h', 'a', 'i', 't','a','l','e','e' ]
console.log(Array.from({name:"chaitalee"}));//it will give empty array because we have to specify for what we have to make the array
